...
def get_directory_size(directory_structure: DirectoryStructure, size_threshold: int) -> Dict[Path, int]:
...
def total_directory_size(folder_path: Path, directory_structure: DirectoryStructure) -> int:
    total_size = 0
